...
<body class="h-full">
	<main
		...
		<div class="text-center bg-white p-12 rounded-lg shadow-lg">
			...
			<h1
				class="mt-4 text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
				Internal Server Error</h1>
			<p class="mt-6 text-lg font-medium text-gray-500 sm:text-xl/8">
				Sorry, something went wrong on our end.</p>
			<div class="mt-10 flex items-center justify-center gap-x-6">
				<a href="<%=request.getContextPath()%>/index.jsp"
					class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
					Go back home </a> <a href="mailto:support@yourdomain.com"
