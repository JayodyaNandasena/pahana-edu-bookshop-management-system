...
<body class="h-full">
	<main
		...
		<div class="text-center bg-white py-12 px-20 rounded-lg shadow-lg">
			...
			<h1
				class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Page
				not found</h1>
			<p
			...
			<div class="mt-10 flex items-center justify-center gap-x-6">
				<a href="<c:url value='/dashboard' />"
					...
					back to dashboard</a> <a href="#" class="text-sm font-semibold text-gray-900">Contact
