	...
	<div class="mb-8">
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-3xl font-bold text-green-600">
							<span>Rs. </span>${totalBills != null ? totalBills : '0.00'}</p>
					</div>
					<div
			...
			<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-gray-500 text-sm font-medium">Average Order
							Value</p>
						<p class="text-3xl font-bold text-blue-600">
							<span>Rs. </span>${averageBills != null ? averageBills : '0.00'}</p>
					</div>
					<div
			...
			<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-3xl font-bold text-purple-600">${activeCustomerCount != null ? activeCustomerCount : '0'}</p>
					</div>
					<div
			...
			<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-gray-500 text-sm font-medium">Average Revenue
							per Customer</p>
						<p class="text-3xl font-bold text-orange-600">
							<span>Rs. </span>${averagePerCustomer != null ? averagePerCustomer : '0.00'}</p>
					</div>
					<div
						...
						<c:forEach var="book" items="${lowStockBooks}">
							<div
								...
								<div class="text-right">
									<p class="text-sm font-semibold text-yellow-700">${book.stock}
										left</p>
							...
							<div
								...
								<div class="text-right">
									<span
										...
										Out of Stock </span>
									<p class="text-xs text-gray-500 mt-1">Last sold:
										${book.lastSoldDate}</p>
								</div>
							</div>
						</c:forEach>
