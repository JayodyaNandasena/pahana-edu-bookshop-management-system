...
<div
	...
	<!-- Modal body -->
	<div class="px-6 py-5">
		<form class="space-y-4" action="item?action=update" method="post"
			id="update-item-form">
			...
			<div class="space-y-2">
				...
				</label> <input type="text" name="u_name" id="update-name"
			...
			<div class="space-y-2">
				<label for="update-category"
					...
					class="text-red-500">*</span>
				</label> <select name="u_category" id="update-category"
			...
			<div class="space-y-2">
				...
				</label> <input type="number" name="u_price" id="update-price" min="0.01"
			...
			<div class="space-y-2">
				...
				</label> <input type="number" name="u_quantity" id="update-quantity" min="1"
					max="10000"
